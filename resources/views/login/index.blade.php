...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card mb-2 ">
                    <div class="card-header text-center bg-success text-white">users Application </div>
                </div>
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <a href="/admin/singup/create" class="btn btn-success btn-sm ml-2 text-sm-center p-2">
                            Add New users
                        </a>
                    </div>
                </div>
                ...
                <table class="data-table table stripe hover nowrap dataTable collapsed" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1" colspan="1" aria-label="Name">Email</th>
                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1" colspan="1" aria-label="Name">Passwoed</th>
                            <th class="table-plus datatable-nosort sorting_asc" rowspan="1" colspan="1" aria-label="Name">User Type</th>
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="table-plus sorting_1" tabindex="0">{{ $item->email }}</td>                          
                            <td class="table-plus sorting_1" tabindex="0">{{ $item->password }}</td>  
                            <td class="table-plus sorting_1" tabindex="0">{{ $item->usertype }}</td>  
                            <td class="table-plus sorting_1" tabindex="0">
                                @if($item->image)
                                    <img src="{{ asset('photo/user/' . $item->image) }}" 
                            ...
                            <td>
                               <div class="d-flex align-items-center justify-between p-0">
                                ...
                                <a href="{{ url('/admin/users/edit/' . $item->id . '/' . strtolower(str_replace(' ', '-', trim($item->name)))) }}" 
                                ...
                                <form class="d-inline"  method="POST" action="{{ url('/admin/users/delete/'. $item->id) }}"
