...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card mb-2 ">
                    <div class="card-header text-center bg-success text-white">categories Application </div>
                </div>
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <a href="/admin/categories/create" class="btn btn-success btn-sm ml-2 text-sm-center p-2">
                            Add New courses
                        </a>
                    </div>
                </div>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                               <div class="d-flex align-items-center justify-between p-0">
                                ...
                                <a href="{{ url('/admin/categories/edit/' . $item->id . '/' . strtolower(str_replace(' ', '-', trim($item->name)))) }}" 
                                ...
                                <form class="d-inline"  method="POST" action="{{ url('/admin/categories/delete/'. $item->id) }}"
                                    onsubmit="return confirm('Are you sure you want to delete this category? <{{ $item->name }}>')">
                                   @csrf
                                   @method('DELETE')
