...
<div class="row">
    <div class="col-12 mb-15">
        <div class="card mb-2">
            <div class="card-header text-center bg-success text-white">Student Borrow Books Update Form</div>
        </div>
    ...
    <div class="col-12">
        <form action="{{ url('/admin/borrows/update/' . $borrows->id . '/' . $borrows->name) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Name" value="{{ $borrows->name }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="gender" class="form-label">Gender</label>
                                <select id="gender" name="gender" class="form-control" aria-label="Default select example" required>
                                    <option value="Male" {{ $borrows->gender == 'Male' ? 'selected' : '' }}>Male</option>
                                    <option value="Female" {{ $borrows->gender == 'Female' ? 'selected' : '' }}>Female</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                @if($borrows->image)
                                    <img src="{{ asset('photo/borrow/' . $borrows->image) }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input id="image" name="image"  value="{{ $borrows->image }}" class="form-control" type="file" id="formFile">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="phone" class="form-control" placeholder="Phone" value="{{ $borrows->phone }}" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea id="address" name="address" style="width: 100%; height: 100px; padding: 10px; 
                                    ...
                                    placeholder="Address...">{{ $borrows->address }}</textarea>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select id="book_id" name="book_id" class="form-control" aria-label="Default select example" required>
                                    ...
                                    <option value="{{ $item->id }}" {{ $item->id === $borrows->book_id ? 'selected' : '' }}>
                                        {{ $item->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select id="class_id" name="class_id" class="form-control" aria-label="Default select example" required>
                                    ...
                                    <option value="{{ $item->id }}" {{ $item->id === $borrows->class_id ? 'selected' : '' }}>
                                        {{ $item->name }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="booking" class="form-control" id="booking" value="{{ $borrows->booking }}" required>

                                <input type="hidden" name="status" class="form-control" id="" value="{{ $borrows->status }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
