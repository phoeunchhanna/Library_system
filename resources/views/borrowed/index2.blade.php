...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card mb-2 ">
                    <div class="card-header text-center bg-success text-white">Students Returned Books Application </div>
                </div>
                <div class="row mb-5">
                ...
                <div class="d-flex justify-content-center ">
                    <nav aria-label="Page navigation example ">
                        <ul class="pagination ">
                            <li class="page-item {{ $returned->previousPageUrl() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $returned->previousPageUrl() ?? '#' }}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                            @for($i = 1; $i <= $returned->lastPage(); $i++)
                                <li class="page-item {{ $i === $returned->currentPage() ? 'active' : '' }}">
                                    <a class="page-link" href="{{ $returned->url($i) }}">{{ $i }}</a>
                                </li>
                            @endfor
                            <li class="page-item {{ $returned->nextPageUrl() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $returned->nextPageUrl() ?? '#' }}" aria-label="Next">
