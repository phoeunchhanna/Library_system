...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card mb-2 ">
                    <div class="card-header text-center bg-success text-white">Borrow Application </div>
                </div>
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <a href="/admin/borrows/create" class="btn btn-success btn-sm ml-2 text-sm-center p-2">
                            Add New borrows
                        </a>
                    </div>
                </div>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="text-center">
                               <div class="d-flex align-items-center justify-between p-0">                   
                                ...
                                <form class="d-inline"  method="POST" action="{{ url('/admin/borrows/delete/'. $item->id) }}"
                ...
                <div class="d-flex justify-content-center ">
                    <nav aria-label="Page navigation example ">
                        <ul class="pagination ">
                            <li class="page-item {{ $classDetail->previousPageUrl() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $classDetail->previousPageUrl() ?? '#' }}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                            @for($i = 1; $i <= $classDetail->lastPage(); $i++)
                                <li class="page-item {{ $i === $classDetail->currentPage() ? 'active' : '' }}">
                                    <a class="page-link" href="{{ $classDetail->url($i) }}">{{ $i }}</a>
                                </li>
                            @endfor
                            <li class="page-item {{ $classDetail->nextPageUrl() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $classDetail->nextPageUrl() ?? '#' }}" aria-label="Next">
    ...
    <script>
       ...
       function status(id, status){
        ...
        $.ajax({
            url: "/admin/borrows/status-update/" + id + "/" + st,
