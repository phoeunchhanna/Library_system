...
<div class="row">
    <div class="col-12  mb-15">
        <div class="card mb-2">
            <div class="card-header text-center bg-success text-white">Authors Create Form</div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="Nationality" class="form-control" placeholder="Nationality" value="" required>
                    </div>
                </div>
